...
Context: Task 015 audit identified weak offer decision clarity as a launch blocker. Current customer-facing copy explains Essential as report only and Executive as report + 7-day chatbot, but the value difference is still too thin at decision time.
...
- Clarify Executive as the report plus a bounded 7-day report-linked interpretation window.
...
Acceptance checks:
- rg -n "Essential|Executive|7-day|chatbot|coaching|report only|report-only" docs/amc_delivery_modes.md docs/amc_landing_page_copy_compact.md docs/amc_landing_page_draft.md docs/amc_landing_page_handoff.md manus-ui/client/src/pages || true
- git diff --check
