...
pnpm --dir manus-ui exec tsx ../scripts/run_amc_report.ts --comparative --strict-undeclared --out "$PWD/output/AMC_Report_ci_comparative.docx" --payload "$PWD/output/amc_docx_payload_ci_comparative.json"
